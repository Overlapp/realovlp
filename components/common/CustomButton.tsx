...
const buttonColorConfig: {
  ...
  primary: {
    default: {
			bgColor: 'bg-transparent border-primary',
			color: 'text-black',
			hover: 'hover:bg-primary hover:border-primary-700',
			focus: 'focus:bg-primary focus:border-primary-700 focus:ring-primary',
			active: 'active:bg-midnight-600 active:border-primary-700 active:ring-primary',
			...
			disabled: 'disabled:bg-midnight-300 disabled:border-primary-300',
    ...
    outline: {
      bgColor: 'border-primary bg-transparent',
			color: 'text-black',
			hover: 'hover:bg-midnight hover:border-primary hover:text-white',
